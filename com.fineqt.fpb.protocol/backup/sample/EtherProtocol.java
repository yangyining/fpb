...
public interface EtherProtocol extends IRecordSetValue {
	IOctetstringValue getDstAddress();
	IOctetstringValue getSrcAddress();
	IIntegerValue getEtherType();
	EtherPayload getPayload();
	POctetstringValue getFcs();
}
