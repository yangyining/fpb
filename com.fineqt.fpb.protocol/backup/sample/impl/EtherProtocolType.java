...
public class EtherProtocolType extends PRecordTypeExtBase {

	public EtherProtocolType(PType pmodel, PModuleExt pmoduleExt) {
		super(pmodel, pmoduleExt);
	}

	@Override
	public PValue createNormalValue(CreatePTypeValueParamaters paras) {
		return (PValue)EtherProtocolImpl.createValue(this, false);
	}

	@Override
	public PValue createOmitValue() {
		return (PValue)EtherProtocolImpl.createValue(this, true);
	}

	@Override
	public PValue createEmptyValue() {
		return (PValue)EtherProtocolImpl.createEmptyValue(this);
	}
