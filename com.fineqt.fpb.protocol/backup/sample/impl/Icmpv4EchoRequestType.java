...
public class Icmpv4EchoRequestType extends PRecordTypeExtBase {

	public Icmpv4EchoRequestType(PType pmodel, PModuleExt pmoduleExt) {
		super(pmodel, pmoduleExt);
	}

	@Override
	public PValue createNormalValue(CreatePTypeValueParamaters paras) {
		return (PValue)Icmpv4EchoRequestImpl.createValue(this, false);
	}

	@Override
	public PValue createOmitValue() {
		return (PValue)Icmpv4EchoRequestImpl.createValue(this, true);
	}

	@Override
	public PValue createEmptyValue() {
		return (PValue)Icmpv4EchoRequestImpl.createEmptyValue(this);
	}
