...
public class Ipv4SecurityOptionType extends PRecordTypeExtBase {

	public Ipv4SecurityOptionType(PType pmodel, PModuleExt pmoduleExt) {
		super(pmodel, pmoduleExt);
	}

	@Override
	public PValue createNormalValue(CreatePTypeValueParamaters paras) {
		return (PValue)Ipv4SecurityOptionImpl.createValue(this, false);
	}

	@Override
	public PValue createOmitValue() {
		return (PValue)Ipv4SecurityOptionImpl.createValue(this, true);
	}

	@Override
	public PValue createEmptyValue() {
		return (PValue)Ipv4SecurityOptionImpl.createEmptyValue(this);
	}
