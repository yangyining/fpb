...
public class Icmpv4ProtocolType extends PUnionTypeExtBase {

	public Icmpv4ProtocolType(PType pmodel, PModuleExt pmoduleExt) {
		super(pmodel, pmoduleExt);
	}

	@Override
	public PValue createNormalValue(CreatePTypeValueParamaters paras) {
		return (PValue)Icmpv4ProtocolImpl.createValue(this, false);
	}

	@Override
	public PValue createOmitValue() {
		return (PValue)Icmpv4ProtocolImpl.createValue(this, true);
	}

	@Override
	public PValue createEmptyValue() {
		return (PValue)Icmpv4ProtocolImpl.createEmptyValue(this);
	}
