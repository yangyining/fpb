...
public class Ipv4LssrOptionType extends PRecordTypeExtBase {

	public Ipv4LssrOptionType(PType pmodel, PModuleExt pmoduleExt) {
		super(pmodel, pmoduleExt);
	}

	@Override
	public PValue createNormalValue(CreatePTypeValueParamaters paras) {
		return (PValue)Ipv4LssrOptionImpl.createValue(this, false);
	}

	@Override
	public PValue createOmitValue() {
		return (PValue)Ipv4LssrOptionImpl.createValue(this, true);
	}

	@Override
	public PValue createEmptyValue() {
		return (PValue)Ipv4LssrOptionImpl.createEmptyValue(this);
	}
