...
public class EtherPayloadType extends PUnionTypeExtBase {

	public EtherPayloadType(PType pmodel, PModuleExt pmoduleExt) {
		super(pmodel, pmoduleExt);
	}

	@Override
	public PValue createNormalValue(CreatePTypeValueParamaters paras) {
		return (PValue)EtherPayloadImpl.createValue(this, false);
	}

	@Override
	public PValue createOmitValue() {
		return (PValue)EtherPayloadImpl.createValue(this, true);
	}

	@Override
	public PValue createEmptyValue() {
		return (PValue)EtherPayloadImpl.createEmptyValue(this);
	}
