...
public class ArpProtocolType extends PRecordTypeExtBase {

	public ArpProtocolType(PType pmodel, PModuleExt pmoduleExt) {
		super(pmodel, pmoduleExt);
	}

	@Override
	public PValue createNormalValue(CreatePTypeValueParamaters paras) {
		return (PValue)ArpProtocolImpl.createValue(this, false);
	}

	@Override
	public PValue createOmitValue() {
		return (PValue)ArpProtocolImpl.createValue(this, true);
	}

	@Override
	public PValue createEmptyValue() {
		return (PValue)ArpProtocolImpl.createEmptyValue(this);
	}
