...
public class EntityModuleParSymbol extends EntityModuleElementSymbolBase 
implements ModuleParMV {
	private PEntityModulePar model;
	
	public EntityModuleParSymbol(ModuleMV module, String name,
			String baseTypeName) {
	...
	public PEntityModulePar getModel() {
		return model;
	}

	public void setModel(PEntityModulePar model) {
		this.model = model;
	}
