...
public class Protocol3Type extends PRecordTypeExtBase {
	
	public Protocol3Type(PType pmodel, PModuleExt pmoduleExt) {
		super((PRecord)pmodel, pmoduleExt);
	}

	@Override
	public PValue createNormalValue(CreatePTypeValueParamaters paras) {
		return (PValue)Protocol3Impl.createValue(this, false);
	}

	@Override
	public PValue createOmitValue() {
		return (PValue)Protocol3Impl.createValue(this, true);
	}

	@Override
	public PValue createEmptyValue() {
		return (PValue)Protocol3Impl.createEmptyValue(this);
	}
