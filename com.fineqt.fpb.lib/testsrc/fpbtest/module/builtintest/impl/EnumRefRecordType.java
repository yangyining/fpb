...
public class EnumRefRecordType extends PRecordTypeExtBase {

	public EnumRefRecordType(PType pmodel, PModuleExt pmoduleExt) {
		super((PRecord)pmodel, pmoduleExt);
	}

	@Override
	public PValue createNormalValue(CreatePTypeValueParamaters paras) {
		return (PValue)EnumRefRecordImpl.createValue(this, false);
	}

	@Override
	public PValue createOmitValue() {
		return (PValue)EnumRefRecordImpl.createValue(this, true);
	}

	@Override
	public PValue createEmptyValue() {
		return (PValue)EnumRefRecordImpl.createEmptyValue(this);
	}
