...
public class BufferBoundaryException extends BitBufferException {
    public final static long serialVersionUID = 0;

    public BufferBoundaryException(int position, int unit) {
        super("Position of " + position + " is not the multiple of " + unit + ".");
    }
}
