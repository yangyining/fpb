...
abstract public class PStringTypeExtBase extends PPrimitiveTypeExtBase {

	public PStringTypeExtBase(PType pmodel, PModuleExt pmoduleExt) {
		super(pmodel, pmoduleExt);
	}

	abstract public static class PStringEVExt extends PFpbPrimitiveEVExt {
		public PStringEVExt(PFpbTypeEV model) {
			super(model);
		}
