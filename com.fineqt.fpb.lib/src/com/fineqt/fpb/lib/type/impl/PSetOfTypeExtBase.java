...
abstract public class PSetOfTypeExtBase extends PListTypeExtBase {

	public PSetOfTypeExtBase(PSetOf pmodel, PModuleExt pmoduleExt) {
	...
	public static class PFpbSetOfEVExt extends PFpbListEVExt {

		public PFpbSetOfEVExt(PFpbTypeEV model) {
			super(model);
		}
