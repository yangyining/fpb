...
public interface PTypeEVExtFactory extends PModuleExtEventListener {
	EncodingType supportEncoding();
	
	PTypeEVExt createTypeEVExt(PTypeExt typeMeta, PTypeEV evModel);
}
