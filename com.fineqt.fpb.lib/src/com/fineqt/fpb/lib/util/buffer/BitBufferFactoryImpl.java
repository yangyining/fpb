...
public class BitBufferFactoryImpl implements IBitBufferFactory {

    @Override
    public IEnsurableBitBuffer createEnsurableBuffer() {
        return new SimpleEnsurableBitBuffer();
    }

    @Override
    public IReadWritableBitBuffer createNormalBuffer() {
        return new SimpleBitBuffer();
    }
